...
const SocialIcon: React.FC<SocialIconProps> = ({ icon: Icon }) => (
  <Icon className="social-icon hover:text-[#F8B195] size={30} " />
);
...
const Footer: React.FC = () => {
  ...
  return (
    <div className="bg-deep-teal mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300">
      ...
      <div>
        <h1 className="w-full text-3xl lg:text-4xl xl:text-5xl font-bold text-[##e87041]">CREATIVE.</h1>
        <p className="py-4">
          Shop with Confidence: Discover the latest in electronics, from cutting-edge smartphones to home essentials.
          Our curated selection ensures quality and innovation in every product.
        </p>
